<template>
  <div class="role">
    ...
    <div class="content">
      <PageContent :contentTableConfig="contentTableConfig" pageName="role" @handleNewClick="handleNewClick"
        @handleEditClick="handleEditClick"></PageContent>
    </div>
    <PageDialog ref="dialogRef" :dialogFormConfig="dialogFormConfig" pageName="role" :othersInfo="othersInfo">
      <el-tree ref="treeRef" :data="menuList" show-checkbox node-key="id" highlight-current
...
export default defineComponent({
  ...
  setup() {
    ...
    //公共hook
    const [dialogRef, defaultInfo, handleEditClick, handleNewClick] = usePageDialog(editCallback, null)
    return {
      contentTableConfig,
      searchFormConfig,
      dialogFormConfig,
